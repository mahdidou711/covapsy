...
def sequence_reverse(pwm, rev_start, rev_stable, neutral):
    """
    Exécute la séquence reverse en boucle active (time.monotonic),
    sans time.sleep() pour ne pas bloquer le terminal.
